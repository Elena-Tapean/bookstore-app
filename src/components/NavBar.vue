<template>
    <header class="nav-bar" ref="navBar">
        ...
        <nav>
            ...
            <router-link to="/basket"><span class="basket-logo"><svg width="20" height="20" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>({{ basketTotal }})</span></router-link>

            <router-link to="/login"><button @click="handleLogout">
